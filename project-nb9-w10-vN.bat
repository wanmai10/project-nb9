...
:: 3. Xbox Game Bar
echo  [3/25] ปิด Xbox Game Bar และ Game DVR...
...
:: 7. Battery Saver
echo  [7/25] ปิด Battery Saver อัตโนมัติ...
...
:: 8. USB Power Saving
echo  [8/25] ปิด USB Power Saving...
powercfg -setacvalueindex SCHEME_CURRENT 2a737441-1930-4402-8d77-b2bebba308a3 48e6b7a6-50f5-4782-a5d4-53bb8f07e226 0 >nul 2>&1
powercfg -setactive SCHEME_CURRENT >nul 2>&1
echo        Done!

:: 9. HPET
echo  [9/25] ปิด HPET Dynamic Tick...
...
:: 10. Discord
echo  [10/25] ปิด Discord Hardware Acceleration...
...
:: 11. Registry Tweaks
echo  [11/25] Registry Tweaks ทั้งหมด...
...
:: 12. Nagle Algorithm
echo  [12/25] ปิด Nagle Algorithm...
...
echo  [13/25] ปิด Memory Compression...
powershell -Command "Disable-MMAgent -MemoryCompression -ErrorAction SilentlyContinue" >nul 2>&1
echo        Done!

:: 14. SysMain
echo  [14/25] ปิด SysMain...
sc stop SysMain >nul 2>&1
sc config SysMain start=disabled >nul 2>&1
echo        Done!

:: 15. Paging File อัตโนมัติ
echo  [15/25] ตั้ง Paging File อัตโนมัติ...
...
echo  [16/25] FiveM Priority และ Fullscreen Optimizations...
...
:: 17. Windows Services
echo  [17/25] ปิด Windows Services ที่ไม่จำเป็น...
...
:: 18. Startup Programs
echo  [18/25] ลบ Startup Programs ที่ไม่จำเป็น...
...
:: 19. DNS - Cloudflare
echo  [19/25] เปลี่ยน DNS เป็น Cloudflare...
...
:: 21. GPU Scheduling
echo  [21/25] เปิด Hardware Accelerated GPU Scheduling...
reg add "HKLM\SYSTEM\CurrentControlSet\Control\GraphicsDrivers" /v HwSchMode /t REG_DWORD /d 2 /f >nul 2>&1
echo        Done!

:: 22. ปิด Telemetry
echo  [22/25] ปิด Windows Telemetry...
...
:: 23. CPU Scheduler
echo  [23/25] ปรับ CPU Scheduler...
reg add "HKLM\SYSTEM\CurrentControlSet\Control\PriorityControl" /v Win32PrioritySeparation /t REG_DWORD /d 26 /f >nul 2>&1
echo        Done!

:: 24. FiveM Config - ต่ำสุดสำหรับ Notebook
echo  [24/25] ปรับ FiveM Config Files (Notebook Mode)...
...
echo.
echo  ------------------------------------------------
echo  ✓ Win10 vN (Notebook) เสร็จแล้ว!
