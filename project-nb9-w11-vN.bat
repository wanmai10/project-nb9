@echo off
title Project NB9 - Windows 11 vN (Notebook)
color 0A
chcp 65001 >nul
...
:: 1. Power Plan
echo  [1/28] Power Plan - High Performance (Plugged In)...
...
:: 2. Visual Effects
echo  [2/28] Visual Effects - Best Performance...
...
:: 27. Network Adapter
echo  [27/28] Network Adapter Settings...
...
echo.
pause
shutdown /r /t 5 /c "Restarting for Project NB9 Win11 vN..."
