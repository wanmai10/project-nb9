...
:: 1. Power Plan
echo  [1/23] Power Plan - High Performance...
...
:: 2. Visual Effects
echo  [2/23] Visual Effects - Best Performance...
...
:: 23. Network Adapter
echo  [23/23] Network Adapter Settings...
...
echo.
pause
shutdown /r /t 5 /c "Restarting for Project NB9 v1..."
