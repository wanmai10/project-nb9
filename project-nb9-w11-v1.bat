@echo off
title Project NB9 - Windows 11 v1 (RAM น้อยกว่า 16GB)
color 0A
chcp 65001 >nul
...
:: 3. Xbox Game Bar
echo  [3/26] ปิด Xbox Game Bar และ Game DVR...
...
:: 4. Background Apps
echo  [4/26] ปิด Background Apps...
reg add "HKCU\Software\Microsoft\Windows\CurrentVersion\BackgroundAccessApplications" /v GlobalUserDisabled /t REG_DWORD /d 1 /f >nul 2>&1
reg add "HKLM\SOFTWARE\Policies\Microsoft\Windows\AppPrivacy" /v LetAppsRunInBackground /t REG_DWORD /d 2 /f >nul 2>&1
echo        Done!

:: 5. ปิด VBS / HVCI (Win11 เฉพาะ - กิน FPS มาก)
echo  [5/26] ปิด VBS และ HVCI...
reg add "HKLM\SYSTEM\CurrentControlSet\Control\DeviceGuard" /v EnableVirtualizationBasedSecurity /t REG_DWORD /d 0 /f >nul 2>&1
reg add "HKLM\SYSTEM\CurrentControlSet\Control\DeviceGuard\Scenarios\HypervisorEnforcedCodeIntegrity" /v Enabled /t REG_DWORD /d 0 /f >nul 2>&1
bcdedit /set hypervisorlaunchtype off >nul 2>&1
echo        Done!

:: 6. ปิด Xbox Widgets และ Teams (Win11 เฉพาะ)
echo  [6/26] ปิด Widgets และ Teams...
...
:: 8. USB Power Saving
echo  [8/26] ปิด USB Power Saving...
powercfg -setacvalueindex SCHEME_CURRENT 2a737441-1930-4402-8d77-b2bebba308a3 48e6b7a6-50f5-4782-a5d4-53bb8f07e226 0 >nul 2>&1
powercfg -setactive SCHEME_CURRENT >nul 2>&1
echo        Done!

:: 9. HPET
echo  [9/26] ปิด HPET Dynamic Tick...
...
:: 10. Discord
echo  [10/26] ปิด Discord Hardware Acceleration...
...
:: 11. Registry Tweaks
echo  [11/26] Registry Tweaks ทั้งหมด...
...
:: 12. Nagle Algorithm
echo  [12/26] ปิด Nagle Algorithm...
...
:: 13. SysMain
echo  [13/26] ปิด SysMain...
sc stop SysMain >nul 2>&1
sc config SysMain start=disabled >nul 2>&1
echo        Done!

:: 14. Paging File
echo  [14/26] ตั้ง Paging File อัตโนมัติ...
...
:: 17. Windows Services
echo  [17/26] ปิด Windows Services ที่ไม่จำเป็น...
...
:: 18. Startup Programs
echo  [18/26] ลบ Startup Programs ที่ไม่จำเป็น...
...
:: 19. DNS - Cloudflare
echo  [19/26] เปลี่ยน DNS เป็น Cloudflare...
...
:: 21. GPU Scheduling
echo  [21/26] เปิด Hardware Accelerated GPU Scheduling...
reg add "HKLM\SYSTEM\CurrentControlSet\Control\GraphicsDrivers" /v HwSchMode /t REG_DWORD /d 2 /f >nul 2>&1
echo        Done!

:: 22. ปิด Telemetry
echo  [22/26] ปิด Windows Telemetry...
...
:: 26. ปิด Win11 Search Highlights
echo  [26/26] ปิด Search Highlights และ Recommendations...
...
echo.
echo  ------------------------------------------------
echo  ✓ Win11 v1 (RAM 16-) เสร็จแล้ว!
